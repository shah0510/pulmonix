...
class Items(models.Model):
    ...
    Product_name = models.ForeignKey(Product_name, null=True, related_name='items', on_delete=models.CASCADE)
    ...
    Issue_date = models.DateField(null=True,verbose_name="Date" )
   
    is_sold = models.BooleanField('Paid', default=False)
    created_by = models.ForeignKey(User, related_name='items', on_delete= models.CASCADE)
    created_at = models.DateTimeField(auto_now_add=True)
    Reference = models.TextField(blank=True, null=True)
    Vendor = models.TextField(blank=True, null=True, verbose_name="Supplied by")

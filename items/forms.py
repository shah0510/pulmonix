...
class NewItemForm(forms.ModelForm):
    ...
    class Meta:
        model = Items
        fields = ['id','Patient_name','Vendor','Product_name','Product_code','Issue_date', 'Amount','Technician','Contact','Reference','Address']
...
class EditItemForm(forms.ModelForm):
    class Meta:
        model = Items
        fields = ['Patient_name', 'Amount', 'is_sold','Vendor','Reference','Address', 'Issue_date', 'Contact']
